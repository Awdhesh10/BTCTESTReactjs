...
{ 
  ...
  const handleSavetext = async (e) => {    
    ...
    setLoading(true);  
    try {    
      // Show SweetAlert2 modal with a Start button
  ...
  const totalTime = 1 * 60; // 45 minutes in seconds
  ...
  return (
    <div className="container-fluid messaging-wrapper">
      ...
      <div className="row p-2">
        <div
          className="text-block mt-2 justify-content-start"
          style={{
      ...
      <div className="row">
        ...
        <form ref={formRef} onSubmit={handleSavetext}>
          ...
          <div className="form-text text-danger mb-2">
            Note: Once you click "Start", the test will begin and the timer will start counting down. You cannot pause or stop the test once it has started.
          </div>
